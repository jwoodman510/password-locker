<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ServerDepartments.aspx.cs" Inherits="Ksu.PasswordLocker.Manage.ServerDepartments" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <link href="../Styles/styles.css" rel="stylesheet" type="text/css"/>
    <div class="row">
        <asp:Label ID="ServerName" runat="server" Text="" stye="font-size:24;font-weight:bold;"></asp:Label>
    </div>
    <div class="row">
